...
A Publication is the defined set of documentation Doc Holiday keeps current over time; see [Publications](/d1-publications.md). This guide shows the quickest path to a first setup in the app, with the Sources, docs destination, and output types that matter for the first pass.
...
7. Add a brief trigger note if needed; see [Configure triggers](/d2-configure-triggers.md). Finish by selecting **"Save Changes"**.
