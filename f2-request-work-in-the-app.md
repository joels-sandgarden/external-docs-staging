...
## Follow progress and verify

After submission, the toast titled "Work Request Created" says "Your work request has been submitted." Select "View in Work History" to open [Work History](/f4-work-history.md).

### Verify

The new entry appears in Work History.

## Next

For help shaping the request text, see [writing requests](/p2-writing-requests.md).