...
| Term | Definition |
| --- | --- |
| Publication | The docs set Doc Holiday keeps current: one docs destination, its sources, and its guidance. See [/d1-publications.md](/d1-publications.md). |
| Source | The reader-facing term for a connected system. Use it in product pages. See [/j8-connection-types.md](/j8-connection-types.md). |
...
| staged / Ready for Review | The state where proposed changes wait for human review. See [/f3-review-and-revise.md](/f3-review-and-revise.md). |
...
| publishing system | The docs site generator or publishing target that serves the docs destination. See [/d4-publishing-systems.md](/d4-publishing-systems.md). |
...
| documentation drift | The gap between current source behavior and the current docs. |