...
Settings → Billing shows the available plans, trial status, and billing messages. The page shows three plan cards for the current billing options and is available to admins on the Bring Your Own Key and Open Source plans; Enterprise billing is handled with the account team.
