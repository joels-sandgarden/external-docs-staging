...
Our Open Source Plan is free for public open source projects and runs on the provider key the organization connects for inference. Doc Holiday appends a Doc Holiday attribution footer to Markdown files on the OSS tier. See [AI provider keys](./h3-ai-provider-keys.md) for provider setup and management.
