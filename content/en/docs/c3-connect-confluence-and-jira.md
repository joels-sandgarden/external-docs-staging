...
3. If the form includes a pause option, leave it available for temporary stops without removing the Source.
...
7. If the form includes a pause option, leave it available for temporary stops without removing the Source.
