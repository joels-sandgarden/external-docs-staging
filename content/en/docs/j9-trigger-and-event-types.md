...
| Event | Typical output | GitHub Repository | GitHub Repository (personal access token) | GitLab (multi-project access token) | GitLab Project | Bitbucket Repository (repository access token) | Bitbucket Project | Linear | Jira Project | Atlassian Forge Jira Project |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | |
