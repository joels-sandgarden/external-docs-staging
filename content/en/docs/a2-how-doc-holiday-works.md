...
Doc Holiday reads the real source, compares it with the docs it maintains, and drafts proposed diffs. Supported organizations can opt into a Bedrock GPT-5.6 drafting mode, but the request, plan, draft, review, and pull request flow stays the same. The drafts wait for your review on a working branch; nothing reaches your default branch except through a pull request you approve.
