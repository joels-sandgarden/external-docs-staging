...
Use this page to manage the OpenAI keys that power an organization’s writing runs. The app page title is **AI Provider Keys**. OpenAI is the only supported provider on this page. The page applies to organizations on Bring Your Own Key and Open Source Software plans. Enterprise inference is managed by Doc Holiday; see [Billing and plans](/h4-billing-and-plans.md).
