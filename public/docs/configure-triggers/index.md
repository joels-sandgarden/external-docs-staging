...
This guide explains how to configure automatic trigger behavior for an existing Publication. See [Concepts](./a3-concepts.md) for Publication and Source definitions. Use it when a Publication should react to new activity in one of its connected Sources.
