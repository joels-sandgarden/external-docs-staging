...
Doc Holiday gives the best result when your standing guidance and your one-off request point to the same outcome. The Library, the Publication, and Work History are the shared parts of that model; [Concepts](/a3-concepts.md) names them.
