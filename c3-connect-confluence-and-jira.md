...
Use this guide when Doc Holiday needs Confluence for read only context or Jira for work that starts from Publication triggers. For a broader model of Sources, see [Sources](/c1-sources.md).
...
Use the app backed path when Jira should connect through an Atlassian application.
...
6. Complete **Source Name** and **Jira Project**. When more than one app exists, use **Atlassian Application** to choose the provider.
7. Select **Save Changes**.

## Jira token-based setup

Use the token based path when Jira should connect without an Atlassian application.
