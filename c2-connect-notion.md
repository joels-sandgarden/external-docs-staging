...
2. Enter a **Source Name** that helps you recognize the Source later.
3. If the control appears, turn on **Pause Background Work for Source** to pause background updates.
4. Enter the **Integration Key** for the Notion integration that can access the pages you want Doc Holiday to read.
5. Save the Source.
